...
export const PACKAGE_CONTENT_FALLBACK =
  'Package details and inclusions are shared on enquiry. Our Dubai team will provide the exact itinerary, pricing, and travel information for your selected package.'
...
export const umrahPackages: TravelPackage[] = [
  {
    ...
    tag: 'Economic',
    season: '',
    summary: PACKAGE_CONTENT_FALLBACK,
    ...
    features: [PACKAGE_CONTENT_FALLBACK],
    highlights: [PACKAGE_CONTENT_FALLBACK],
    amenities: [
      ...defaultAmenities,
    ],
    pendingContent: true,
